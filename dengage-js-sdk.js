(function () {
  ...
  function refreshSubscription(registration) {
    return registration.pushManager.getSubscription().then(function (subscription) {
      if (subscription) {
        if (base64Normalize(arrayBufferToBase64(subscription.options.applicationServerKey)) == base64Normalize('BJnJ_PO2DHLkWmn6ha4K4Ahwt4G7PolU7TA-w52UPT9A0eeWh4EEcT3dD9tSxwMciJDuDEc2ZbBDxBjawExj4KM')) {
